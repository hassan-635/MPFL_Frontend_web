...
const LoginSidebar = () => (
  <div className="hidden lg:flex bg-slate-900 items-center justify-center p-12 relative overflow-hidden">
    ...
    <div className="relative z-10 text-center">
      <div className="w-24 h-24 bg-blue-600 rounded-[32px] flex items-center justify-center mx-auto mb-8 shadow-2xl rotate-3 hover:rotate-0 transition-transform duration-500">
        <span className="text-white text-4xl font-black italic">M</span>
      </div>
      <h3 className="text-3xl font-black text-white mb-4 tracking-tight">The Professional Way <br/> to Deliver Projects.</h3>
      <p className="text-slate-400 max-w-sm leading-relaxed font-medium mx-auto">
        Join the elite network of freelancers who value their time and their client's trust.
      </p>
    </div>
  </div>
);
